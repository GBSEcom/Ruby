...
module SwaggerClient
  ...
  class PrimaryTransaction
    ...
    def hash
      [transaction_type, store_id, client_transaction_id, amount, payment_method, order, basket_items, split_shipment, additional_details, industry_specific_extensions, stored_credentials].hash
    end
