  ...
  class ProcessorData
    ...
    def list_invalid_properties
      ...
      if @response_message.nil?
        invalid_properties.push("invalid value for 'response_message', response_message cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @response_message.nil?
      return true
    end
    ...
    def hash
      [response_code, response_message, approval_code].hash
    end
