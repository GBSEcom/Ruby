...
module SwaggerClient
  ...
  class PaymentMethod
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["PAYMENT_CARD", "SEPA", "PAYPAL"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["PAYMENT_CARD", "SEPA", "PAYPAL"])
    ...
    def hash
      [type, payment_card, sepa, pay_pal].hash
    end
