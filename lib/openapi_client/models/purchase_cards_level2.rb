...
module OpenapiClient
  class PurchaseCardsLevel2
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customerReferenceID')
        self.customer_reference_id = attributes[:'customerReferenceID']
      end

      if attributes.has_key?(:'supplierInvoiceNumber')
        self.supplier_invoice_number = attributes[:'supplierInvoiceNumber']
      end

      if attributes.has_key?(:'supplierVATRegistrationNumber')
        self.supplier_vat_registration_number = attributes[:'supplierVATRegistrationNumber']
      end

      if attributes.has_key?(:'totalDiscountAmountAndRate')
        self.total_discount_amount_and_rate = attributes[:'totalDiscountAmountAndRate']
      end

      if attributes.has_key?(:'vatShippingAmountAndRate')
        self.vat_shipping_amount_and_rate = attributes[:'vatShippingAmountAndRate']
      end
    end
