...
module OpenapiClient
  ...
  class AuthenticationRedirectParams
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payerAuthenticationRequest')
        self.payer_authentication_request = attributes[:'payerAuthenticationRequest']
      end

      if attributes.has_key?(:'termUrl')
        self.term_url = attributes[:'termUrl']
      end
