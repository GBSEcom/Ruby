...
module OpenapiClient
  ...
  class WalletPreAuthTransaction < PrimaryTransaction
    attr_accessor :wallet_payment_method
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::WalletPreAuthTransaction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::WalletPreAuthTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'wallet_payment_method')
        self.wallet_payment_method = attributes[:'wallet_payment_method']
      end
      ...
      if attributes.key?(:'payment_facilitator')
        self.payment_facilitator = attributes[:'payment_facilitator']
      end
    ...
    def list_invalid_properties
      ...
      if @wallet_payment_method.nil?
        invalid_properties.push('invalid value for "wallet_payment_method", wallet_payment_method cannot be nil.')
      end
    ...
    def valid?
      return false if @wallet_payment_method.nil?
      true && super
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          wallet_payment_method == o.wallet_payment_method &&
          split_shipment == o.split_shipment &&
          payment_facilitator == o.payment_facilitator &&
    ...
    def hash
      [wallet_payment_method, split_shipment, payment_facilitator, decremental_flag].hash
    end
