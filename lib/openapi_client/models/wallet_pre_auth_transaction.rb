  ...
  class WalletPreAuthTransaction < PrimaryTransaction
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_facilitator == o.payment_facilitator && super(o)
    end
    ...
    def hash
      [request_type, transaction_amount, store_id, merchant_transaction_id, transaction_origin, order, wallet_payment_method, split_shipment, payment_facilitator].hash
    end
