...
module OpenapiClient
  ...
  class Order
    ...
    def hash
      [order_id, billing, shipping, industry_specific_extensions, purchase_card, installment_options, revolving_options, soft_descriptor, additional_details, bancontact_qr].hash
    end
