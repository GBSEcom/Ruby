...
module OpenapiClient
  ...
  class Order
    ...
    attr_accessor :industry_specific_extensions

    attr_accessor :purchase_card

    attr_accessor :installment_options

    attr_accessor :revolving_options

    attr_accessor :stand_in_details

    attr_accessor :soft_descriptor

    attr_accessor :additional_details

    attr_accessor :bancontact_qr
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'industry_specific_extensions')
        self.industry_specific_extensions = attributes[:'industry_specific_extensions']
      end

      if attributes.key?(:'purchase_card')
        self.purchase_card = attributes[:'purchase_card']
      end
      ...
      if attributes.key?(:'stand_in_details')
        self.stand_in_details = attributes[:'stand_in_details']
      end
      ...
      if attributes.key?(:'bancontact_qr')
        self.bancontact_qr = attributes[:'bancontact_qr']
      end
    ...
    def order_id=(order_id)
      if !order_id.nil? && order_id.to_s.length > 100
        fail ArgumentError, 'invalid value for "order_id", the character length must be smaller than or equal to 100.'
      end
    ...
    def hash
      [order_id, billing, shipping, industry_specific_extensions, purchase_card, installment_options, revolving_options, stand_in_details, soft_descriptor, additional_details, bancontact_qr, client_locale].hash
    end
