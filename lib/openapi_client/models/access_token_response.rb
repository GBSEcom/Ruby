...
module OpenapiClient
  ...
  class AccessTokenResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'public_key_base64')
        self.public_key_base64 = attributes[:'public_key_base64']
      end
    ...
    def hash
      [token_id, status, issued_on, expires_in_seconds, public_key_base64, algorithm, client_request_id].hash
    end
