...
module OpenapiClient
  ...
  class PrimaryTransaction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'basketItems')
        if (value = attributes[:'basketItems']).is_a?(Array)
          self.basket_items = value
        end
      end
      ...
      if attributes.has_key?(:'industrySpecificExtensions')
        self.industry_specific_extensions = attributes[:'industrySpecificExtensions']
      end
      ...
      if attributes.has_key?(:'purchaseCard')
        self.purchase_card = attributes[:'purchaseCard']
      end

      if attributes.has_key?(:'paymentFacilitator')
        self.payment_facilitator = attributes[:'paymentFacilitator']
      end
    ...
    def hash
      [transaction_type, store_id, merchant_transaction_id, transaction_origin, amount, payment_method, order, basket_items, split_shipment, additional_details, industry_specific_extensions, stored_credentials, purchase_card, payment_facilitator, soft_descriptor].hash
    end
