...
module OpenapiClient
  ...
  class ScoreOnlyRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'merchantRef')
        self.merchant_ref = attributes[:'merchantRef']
      end
      ...
      if attributes.has_key?(:'originalTransactionType')
        self.original_transaction_type = attributes[:'originalTransactionType']
      end
    ...
    def transaction_type=(transaction_type)
      validator = EnumAttributeValidator.new('String', ['scoreOnly'])
