...
module OpenapiClient
  ...
  class AuthenticationResponseVerification
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'smsVerificationCode')
        self.sms_verification_code = attributes[:'smsVerificationCode']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['SECURE_3D', 'UNIONPAY'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['SECURE_3D', 'UNIONPAY'])
    ...
    def hash
      [type, sms_verification_code, merchant_data, pa_res].hash
    end
