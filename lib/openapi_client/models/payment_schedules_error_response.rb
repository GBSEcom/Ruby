...
module OpenapiClient
  ...
  class PaymentSchedulesErrorResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentSchedulesErrorResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentSchedulesErrorResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_response')
        self.transaction_response = attributes[:'transaction_response']
      end
    ...
    def valid?
      request_status_validator = EnumAttributeValidator.new('String', ["SUCCESS", "VALIDATION_FAILED", "PROCESSING_FAILED", "FAILURE", "DECLINED"])
    ...
    def request_status=(request_status)
      validator = EnumAttributeValidator.new('String', ["SUCCESS", "VALIDATION_FAILED", "PROCESSING_FAILED", "FAILURE", "DECLINED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          order_id == o.order_id &&
          transaction_response == o.transaction_response &&
          error == o.error
    end
    ...
    def hash
      [client_request_id, api_trace_id, response_type, request_status, order_id, transaction_response, error].hash
    end
