...
module OpenapiClient
  ...
  class Payment
    ...
    def self.openapi_types
      {
        ...
        :'pin_present' => :'BOOLEAN',
        :'entry_method' => :'String',
        :'issuer_response' => :'PaymentIssuerResponse',
        :'issuer_approved_amount' => :'String',
        :'issuer_card_balance' => :'String',
        :'verification_avs' => :'PaymentVerificationAvs',
        :'verification3ds' => :'PaymentVerification3ds',
        :'verification_cvv' => :'PaymentVerificationCvv',
        :'user_defined' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pinPresent')
        self.pin_present = attributes[:'pinPresent']
      end
      ...
      if attributes.has_key?(:'issuerResponse')
        self.issuer_response = attributes[:'issuerResponse']
      end

      if attributes.has_key?(:'issuerApprovedAmount')
        self.issuer_approved_amount = attributes[:'issuerApprovedAmount']
      end

      if attributes.has_key?(:'issuerCardBalance')
        self.issuer_card_balance = attributes[:'issuerCardBalance']
      end

      if attributes.has_key?(:'verificationAvs')
        self.verification_avs = attributes[:'verificationAvs']
      end

      if attributes.has_key?(:'verification3ds')
        self.verification3ds = attributes[:'verification3ds']
      end

      if attributes.has_key?(:'verificationCvv')
        self.verification_cvv = attributes[:'verificationCvv']
      end
    ...
    def valid?
      ...
      entry_method_validator = EnumAttributeValidator.new('String', ['manual', 'stripe', 'ocr', 'emv', 'nfc', 'remote', 'pinPresent'])
    ...
    def entry_method=(entry_method)
      validator = EnumAttributeValidator.new('String', ['manual', 'stripe', 'ocr', 'emv', 'nfc', 'remote', 'pinPresent'])
