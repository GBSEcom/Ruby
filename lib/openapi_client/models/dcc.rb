...
module OpenapiClient
  ...
  class Dcc
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'conversionType')
        self.conversion_type = attributes[:'conversionType']
      end
      ...
      if attributes.has_key?(:'dccApplied')
        self.dcc_applied = attributes[:'dccApplied']
      end
    end
