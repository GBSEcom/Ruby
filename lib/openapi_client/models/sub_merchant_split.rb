...
module OpenapiClient
  ...
  class SubMerchantSplit
    ...
    def list_invalid_properties
      ...
      if @merchant_id !~ Regexp.new(/[0-9]{0,15}/)
        invalid_properties.push('invalid value for "merchant_id", must conform to the pattern /[0-9]{0,15}/.')
      end
    ...
    def valid?
      ...
      return false if @merchant_id !~ Regexp.new(/[0-9]{0,15}/)
    ...
    def merchant_id=(merchant_id)
      ...
      if merchant_id !~ Regexp.new(/[0-9]{0,15}/)
        fail ArgumentError, 'invalid value for "merchant_id", must conform to the pattern /[0-9]{0,15}/.'
      end
