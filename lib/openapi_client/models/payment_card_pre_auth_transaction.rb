...
module OpenapiClient
  ...
  class PaymentCardPreAuthTransaction < PrimaryTransaction
    ...
    def hash
      [request_type, transaction_amount, store_id, merchant_transaction_id, transaction_origin, order, payment_method, stored_credentials, create_token, split_shipment, settlement_split, authentication_request, authentication_result].hash
    end
