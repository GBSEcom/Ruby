  ...
  class PaymentCardPreAuthTransaction < PrimaryTransaction
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          settlement_split == o.settlement_split && super(o)
    end
    ...
    def hash
      [request_type, transaction_amount, store_id, merchant_transaction_id, transaction_origin, order, payment_method, stored_credentials, create_token, split_shipment, settlement_split].hash
    end
