...
module OpenapiClient
  ...
  class PaymentTokenSaleTransaction
    ...
    def hash
      [request_type, store_id, merchant_transaction_id, transaction_amount, transaction_origin, order, payment_method, stored_credentials, settlement_split, currency_conversion].hash
    end
