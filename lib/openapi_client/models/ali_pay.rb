...
module OpenapiClient
  ...
  class AliPay
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'paymentDataType')
        self.payment_data_type = attributes[:'paymentDataType']
      end

      if attributes.has_key?(:'paymentData')
        self.payment_data = attributes[:'paymentData']
      end

      if attributes.has_key?(:'orderTitle')
        self.order_title = attributes[:'orderTitle']
      end
