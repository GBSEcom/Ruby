...
module OpenapiClient
  ...
  class PaymentCardPaymentTokenUpdateRequest
    ...
    def self.openapi_types
      {
        :'request_type' => :'String',
        :'store_id' => :'String',
        :'payment_tokens' => :'Array<UpdatePaymentToken>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentCardPaymentTokenUpdateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentCardPaymentTokenUpdateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_tokens')
        if (value = attributes[:'payment_tokens']).is_a?(Array)
          self.payment_tokens = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @payment_tokens.nil?
        invalid_properties.push('invalid value for "payment_tokens", payment_tokens cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payment_tokens.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          store_id == o.store_id &&
          payment_tokens == o.payment_tokens
    end
    ...
    def hash
      [request_type, store_id, payment_tokens].hash
    end
