...
module OpenapiClient
  class InitiateClearingResponseAllOf
    ...
    attr_accessor :clearing_details

    # The array holds response information of the involved endpoints.
    attr_accessor :endpoint_responses
    ...
    def self.openapi_types
      {
        ...
        :'clearing_details' => :'ClearingDetails',
        :'endpoint_responses' => :'Array<EndpointResponse>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InitiateClearingResponseAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InitiateClearingResponseAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'clearing_details')
        self.clearing_details = attributes[:'clearing_details']
      end

      if attributes.key?(:'endpoint_responses')
        if (value = attributes[:'endpoint_responses']).is_a?(Array)
          self.endpoint_responses = value
        end
      end
    end
    ...
    def valid?
      request_status_validator = EnumAttributeValidator.new('String', ["SUCCESS", "PROCESSING_FAILED", "FAILURE"])
    ...
    def request_status=(request_status)
      validator = EnumAttributeValidator.new('String', ["SUCCESS", "PROCESSING_FAILED", "FAILURE"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          clearing_details == o.clearing_details &&
          endpoint_responses == o.endpoint_responses
    end
    ...
    def hash
      [client_request_id, api_trace_id, response_type, request_status, clearing_details, endpoint_responses].hash
    end
