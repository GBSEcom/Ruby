...
module OpenapiClient
  ...
  class Card
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taToken')
        self.ta_token = attributes[:'taToken']
      end

      if attributes.has_key?(:'taTokenKey')
        self.ta_token_key = attributes[:'taTokenKey']
      end
      ...
      if attributes.has_key?(:'expDate')
        self.exp_date = attributes[:'expDate']
      end
      ...
      if attributes.has_key?(:'cardReissuedNumber')
        self.card_reissued_number = attributes[:'cardReissuedNumber']
      end
    end
