...
module OpenapiClient
  ...
  class Error
    ...
    attr_accessor :decline_reason_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'decline_reason_code')
        self.decline_reason_code = attributes[:'decline_reason_code']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          message == o.message &&
          details == o.details &&
          decline_reason_code == o.decline_reason_code
    end
    ...
    def hash
      [code, message, details, decline_reason_code].hash
    end
