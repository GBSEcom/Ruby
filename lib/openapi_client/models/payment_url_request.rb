...
module OpenapiClient
  ...
  class PaymentUrlRequest
    ...
    attr_accessor :hosted_payment_page_text
    ...
    # Custom attribute writer method with validation
    # @param [Object] hosted_payment_page_text Value to be assigned
    def hosted_payment_page_text=(hosted_payment_page_text)
      if !hosted_payment_page_text.nil? && hosted_payment_page_text.to_s.length > 255
    ...
    def hash
      [store_id, client_locale, transaction_amount, transaction_type, order_id, billing, shipping, transaction_notification_url, expiration, authenticate_transaction, dynamic_merchant_name, invoice_number, purchase_order_number, hosted_payment_page_text, ip, revolving_options].hash
    end
