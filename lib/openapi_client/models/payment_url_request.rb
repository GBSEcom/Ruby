...
module OpenapiClient
  ...
  class PaymentUrlRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transactionNotificationURL')
        self.transaction_notification_url = attributes[:'transactionNotificationURL']
      end
      ...
      if attributes.has_key?(:'authenticateTransaction')
        self.authenticate_transaction = attributes[:'authenticateTransaction']
      end
