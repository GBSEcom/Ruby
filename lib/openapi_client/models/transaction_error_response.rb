...
module OpenapiClient
  ...
  class TransactionErrorResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'secure3dResponse')
        self.secure3d_response = attributes[:'secure3dResponse']
      end
    ...
    def valid?
      ...
      transaction_state_validator = EnumAttributeValidator.new('String', ['AUTHORIZED', 'CAPTURED', 'DECLINED', 'CHECKED', 'INITIALIZED', 'PENDING', 'READY', 'SETTLED', 'VOIDED', 'WAITING'])
    ...
    def transaction_state=(transaction_state)
      validator = EnumAttributeValidator.new('String', ['AUTHORIZED', 'CAPTURED', 'DECLINED', 'CHECKED', 'INITIALIZED', 'PENDING', 'READY', 'SETTLED', 'VOIDED', 'WAITING'])
    ...
    def hash
      [client_request_id, api_trace_id, response_type, ipg_transaction_id, order_id, transaction_type, payment_token, transaction_origin, payment_method, country, terminal_id, merchant_transaction_id, transaction_time, approved_amount, transaction_status, transaction_state, secure3d_response, redirect_url, authentication_redirect, scheme_transaction_id, processor, additional_details, error].hash
    end
