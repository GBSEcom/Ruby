...
module OpenapiClient
  ...
  class TransactionErrorResponse
    ...
    attr_accessor :standin_response_details
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payment_account_reference_number')
        self.payment_account_reference_number = attributes[:'payment_account_reference_number']
      end
    ...
    def transaction_status=(transaction_status)
      validator = EnumAttributeValidator.new('String', ["APPROVED", "WAITING", "PARTIAL", "VALIDATION_FAILED", "PROCESSING_FAILED", "DECLINED"])
    ...
    def payment_account_reference_number=(payment_account_reference_number)
      if !payment_account_reference_number.nil? && payment_account_reference_number.to_s.length > 30
        fail ArgumentError, 'invalid value for "payment_account_reference_number", the character length must be smaller than or equal to 30.'
      end
