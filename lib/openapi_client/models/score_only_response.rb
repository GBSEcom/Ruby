...
module OpenapiClient
  ...
  class ScoreOnlyResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fraudScore')
        self.fraud_score = attributes[:'fraudScore']
      end

      if attributes.has_key?(:'recommendedDecision')
        self.recommended_decision = attributes[:'recommendedDecision']
      end
    end
