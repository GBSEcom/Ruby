...
module OpenapiClient
  class DeviceNetworks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'networkType')
      ...
      if attributes.has_key?(:'mobileCountryCode')
        self.mobile_country_code = attributes[:'mobileCountryCode']
      end

      if attributes.has_key?(:'mobileNetworkCode')
        self.mobile_network_code = attributes[:'mobileNetworkCode']
      end

      if attributes.has_key?(:'subscriptionIdentificationNumber')
        self.subscription_identification_number = attributes[:'subscriptionIdentificationNumber']
      end

      if attributes.has_key?(:'locationAreaCode')
        self.location_area_code = attributes[:'locationAreaCode']
      end

      if attributes.has_key?(:'cellId')
        self.cell_id = attributes[:'cellId']
      end
