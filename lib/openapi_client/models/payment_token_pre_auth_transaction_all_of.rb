...
module OpenapiClient
  class PaymentTokenPreAuthTransactionAllOf
    ...
    def hash
      [request_type, transaction_amount, store_id, merchant_transaction_id, transaction_origin, order, payment_method, stored_credentials, split_shipment, settlement_split].hash
    end
