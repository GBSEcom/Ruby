  ...
  class EmailNotificationData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EmailNotificationData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EmailNotificationData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'enable_notification')
        self.enable_notification = attributes[:'enable_notification']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enable_notification == o.enable_notification &&
    ...
    def hash
      [enable_notification, merchant_name, receiver_email, sender_email, locale].hash
    end
