...
module OpenapiClient
  ...
  class PaymentTokenPreAuthTransaction
    ...
    def hash
      [request_type, store_id, merchant_transaction_id, transaction_amount, transaction_origin, order, payment_method, stored_credentials, split_shipment, settlement_split].hash
    end
