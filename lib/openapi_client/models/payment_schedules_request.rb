...
module OpenapiClient
  ...
  class PaymentSchedulesRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'referencedOrderId')
        self.referenced_order_id = attributes[:'referencedOrderId']
      end
    ...
    def hash
      [store_id, referenced_order_id, start_date, number_of_payments, maximum_failures, invoice_number, purchase_order_number, transaction_origin, dynamic_merchant_name, frequency, payment_method, amount, client_locale, order_id, billing, shipping, comments].hash
    end
