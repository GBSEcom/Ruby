...
module OpenapiClient
  ...
  class DynamicPricingExchangeRateRequest
    ...
    def list_invalid_properties
      ...
      if @foreign_currency !~ Regexp.new(/([A-Z]{3})|([0-9]{3})/)
        invalid_properties.push('invalid value for "foreign_currency", must conform to the pattern /([A-Z]{3})|([0-9]{3})/.')
      end
    ...
    def foreign_currency=(foreign_currency)
      ...
      if foreign_currency !~ Regexp.new(/([A-Z]{3})|([0-9]{3})/)
        fail ArgumentError, 'invalid value for "foreign_currency", must conform to the pattern /([A-Z]{3})|([0-9]{3})/.'
      end
