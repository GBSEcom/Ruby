...
module OpenapiClient
  class PaymentTokenizationResponse
    ...
    def hash
      [client_request_id, api_trace_id, response_type, request_status, request_time, avs_response, security_code_response, brand, country, payment_token, payment_card].hash
    end
