...
module OpenapiClient
  ...
  class PaymentCard
    ...
    def list_invalid_properties
      ...
      if @number !~ Regexp.new(/[0-9]{13,19}/)
    ...
    def valid?
      ...
      return false if @number.to_s.length < 13
    ...
    def hash
      [number, expiry_date, security_code, card_function, cardholder_name, authentication, bin, last4, brand].hash
    end
