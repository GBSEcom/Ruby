...
module OpenapiClient
  ...
  class AdditionalDetails
    ...
    def valid?
      ...
      return false if !@operator_id.nil? && @operator_id !~ Regexp.new(/^\S$|^\S[\s\S]*\S$/)
      return false if !@sales_system_id.nil? && @sales_system_id.to_s.length > 50
      return false if !@sales_system_id.nil? && @sales_system_id !~ Regexp.new(/^\S$|^\S[\s\S]*\S$/)
      true
    end
    ...
    def hash
      [comments, invoice_number, purchase_order_number, operator_id, sales_system_id, ipg_deferred_auth].hash
    end
