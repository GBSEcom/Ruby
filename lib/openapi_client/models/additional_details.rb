...
module OpenapiClient
  ...
  class AdditionalDetails
    ...
    def hash
      [comments, invoice_number, purchase_order_number, operator_id, sales_system_id, ipg_deferred_auth, high_risk_purchase_indicator, receipts, sca_exemption_type, sca_visa_merchant_id].hash
    end
