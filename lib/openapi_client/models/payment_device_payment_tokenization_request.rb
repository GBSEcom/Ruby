...
module OpenapiClient
  ...
  class PaymentDevicePaymentTokenizationRequest < PaymentTokenizationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentDevicePaymentTokenizationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentDevicePaymentTokenizationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'create_token')
        self.create_token = attributes[:'create_token']
      end

      if attributes.key?(:'account_verification')
        self.account_verification = attributes[:'account_verification']
      else
        self.account_verification = false
      end

      if attributes.key?(:'payment_device')
        self.payment_device = attributes[:'payment_device']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @payment_device.nil?
        invalid_properties.push('invalid value for "payment_device", payment_device cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payment_device.nil?
      true && super
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_device == o.payment_device && super(o)
    end
    ...
    def hash
      [request_type, store_id, billing_address, create_token, account_verification, payment_device].hash
    end
