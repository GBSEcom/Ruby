...
module OpenapiClient
  ...
  class Billing
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'personalNumber')
        self.personal_number = attributes[:'personalNumber']
      end
    ...
    def list_invalid_properties
      ...
      if !@personal_number.nil? && @personal_number.to_s.length > 20
        invalid_properties.push('invalid value for "personal_number", the character length must be smaller than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@personal_number.nil? && @personal_number.to_s.length > 20
    ...
    def personal_number=(personal_number)
      if !personal_number.nil? && personal_number.to_s.length > 20
        fail ArgumentError, 'invalid value for "personal_number", the character length must be smaller than or equal to 20.'
      end
    ...
    def hash
      [name, customer_id, personal_number, birth_date, gender, contact, address].hash
    end
