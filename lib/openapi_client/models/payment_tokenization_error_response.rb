...
module OpenapiClient
  ...
  class PaymentTokenizationErrorResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentTokenizationErrorResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentTokenizationErrorResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_response_data')
        self.additional_response_data = attributes[:'additional_response_data']
      end
    ...
    def request_status=(request_status)
      validator = EnumAttributeValidator.new('String', ["DELETED", "FAILED", "SUCCESS", "APPROVED", "WAITING", "VALIDATION_FAILED", "DECLINED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_response_data == o.additional_response_data &&
          error == o.error
    end
    ...
    def hash
      [client_request_id, api_trace_id, response_type, request_status, request_time, brand, country, payment_token, payment_card, processor, order_id, ipg_transaction_id, merchant_transaction_id, additional_response_data, error].hash
    end
