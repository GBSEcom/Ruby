...
module OpenapiClient
  ...
  class PaymentTokenizationErrorResponse
    ...
    def hash
      [client_request_id, api_trace_id, response_type, request_status, request_time, brand, country, payment_token, payment_card, processor, order_id, ipg_transaction_id, merchant_transaction_id, error].hash
    end
