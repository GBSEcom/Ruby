...
module OpenapiClient
  ...
  class PaymentCardSaleTransaction < PrimaryTransaction
    ...
    def hash
      [request_type, transaction_amount, store_id, merchant_transaction_id, transaction_origin, order, payment_method, stored_credentials, settlement_split, create_token, currency_conversion].hash
    end
