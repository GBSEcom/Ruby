...
module OpenapiClient
  ...
  class PaymentCardSaleTransaction
    ...
    def hash
      [request_type, store_id, merchant_transaction_id, transaction_amount, transaction_origin, order, payment_method, stored_credentials, settlement_split, create_token, currency_conversion].hash
    end
