...
module OpenapiClient
  ...
  class SubMerchantData
    ...
    def list_invalid_properties
      ...
      if @mcc !~ Regexp.new(/[0-9]{4}/)
        invalid_properties.push('invalid value for "mcc", must conform to the pattern /[0-9]{4}/.')
      end
    ...
    def mcc=(mcc)
      ...
      if mcc !~ Regexp.new(/[0-9]{4}/)
        fail ArgumentError, 'invalid value for "mcc", must conform to the pattern /[0-9]{4}/.'
      end
