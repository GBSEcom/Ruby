...
# Unit tests for OpenapiClient::CardVerificationsTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CardVerificationsTransaction' do
  before do
    # run before each test
    @instance = OpenapiClient::CardVerificationsTransaction.new
  end
  ...
  describe 'test an instance of CardVerificationsTransaction' do
    it 'should create an instance of CardVerificationsTransaction' do
      expect(@instance).to be_instance_of(OpenapiClient::CardVerificationsTransaction)
    end
  end
