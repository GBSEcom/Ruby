...
# Unit tests for OpenapiClient::OrderErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrderErrorResponse' do
  before do
    # run before each test
    @instance = OpenapiClient::OrderErrorResponse.new
  end
  ...
  describe 'test an instance of OrderErrorResponse' do
    it 'should create an instance of OrderErrorResponse' do
      expect(@instance).to be_instance_of(OpenapiClient::OrderErrorResponse)
    end
  end
