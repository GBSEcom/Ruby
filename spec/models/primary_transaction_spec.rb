...
# Unit tests for SwaggerClient::PrimaryTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrimaryTransaction' do
  before do
    # run before each test
    @instance = SwaggerClient::PrimaryTransaction.new
  end
  ...
  describe 'test an instance of PrimaryTransaction' do
    it 'should create an instance of PrimaryTransaction' do
      expect(@instance).to be_instance_of(SwaggerClient::PrimaryTransaction)
    end
  end
