...
# Unit tests for OpenapiClient::PaymentTokenizationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PaymentTokenizationResponse' do
  before do
    # run before each test
    @instance = OpenapiClient::PaymentTokenizationResponse.new
  end
  ...
  describe 'test an instance of PaymentTokenizationResponse' do
    it 'should create an instance of PaymentTokenizationResponse' do
      expect(@instance).to be_instance_of(OpenapiClient::PaymentTokenizationResponse)
    end
  end
