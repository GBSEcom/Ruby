...
# Unit tests for OpenapiClient::ScoreOnlyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ScoreOnlyResponse' do
  before do
    # run before each test
    @instance = OpenapiClient::ScoreOnlyResponse.new
  end
  ...
  describe 'test an instance of ScoreOnlyResponse' do
    it 'should create an instance of ScoreOnlyResponse' do
      expect(@instance).to be_instance_of(OpenapiClient::ScoreOnlyResponse)
    end
  end
