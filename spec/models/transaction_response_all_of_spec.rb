...
# Unit tests for OpenapiClient::TransactionResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransactionResponseAllOf' do
  before do
    # run before each test
    @instance = OpenapiClient::TransactionResponseAllOf.new
  end
  ...
  describe 'test an instance of TransactionResponseAllOf' do
    it 'should create an instance of TransactionResponseAllOf' do
      expect(@instance).to be_instance_of(OpenapiClient::TransactionResponseAllOf)
    end
  end
