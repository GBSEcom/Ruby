...
# Unit tests for OpenapiClient::Secure3D21AuthenticationResultAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Secure3D21AuthenticationResultAllOf' do
  before do
    # run before each test
    @instance = OpenapiClient::Secure3D21AuthenticationResultAllOf.new
  end
  ...
  describe 'test an instance of Secure3D21AuthenticationResultAllOf' do
    it 'should create an instance of Secure3D21AuthenticationResultAllOf' do
      expect(@instance).to be_instance_of(OpenapiClient::Secure3D21AuthenticationResultAllOf)
    end
  end
