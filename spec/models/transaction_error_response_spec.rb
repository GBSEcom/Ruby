...
# Unit tests for SwaggerClient::TransactionErrorResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransactionErrorResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::TransactionErrorResponse.new
  end
  ...
  describe 'test an instance of TransactionErrorResponse' do
    it 'should create an instance of TransactionErrorResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::TransactionErrorResponse)
    end
  end
