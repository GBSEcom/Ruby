...
# Unit tests for SwaggerClient::AirlineTravelRoute
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AirlineTravelRoute' do
  before do
    # run before each test
    @instance = SwaggerClient::AirlineTravelRoute.new
  end
  ...
  describe 'test an instance of AirlineTravelRoute' do
    it 'should create an instance of AirlineTravelRoute' do
      expect(@instance).to be_instance_of(SwaggerClient::AirlineTravelRoute)
    end
  end
